...
const AppearanceWrapper = () => {
    const { i18n, t } = useTranslation('vantablack/account');
    ...
    const modeToggler = String(useStoreState((state: ApplicationStore) => state.settings.data!.vantablack.modeToggler));
    const langSwitch = String(useStoreState((state: ApplicationStore) => state.settings.data!.vantablack.langSwitch));
    const defaultMode = useStoreState((state: ApplicationStore) => state.settings.data!.vantablack.defaultMode);
