...
const TopAlert = styled.div`
    ${tw`fixed w-full px-4 py-3 rounded-component z-40 flex gap-x-3 items-center mx-2 opacity-0`};
    animation: fadeIn 6s;
...
const MessageBox = ({ title, children, type }: Props) => {
    const flashMessage = useStoreState((state: ApplicationStore) => state.settings.data!.vantablack.flashMessage);
