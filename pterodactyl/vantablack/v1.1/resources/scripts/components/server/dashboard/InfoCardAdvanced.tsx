...
const InfoCardAdvanced = () => {
    const { t } = useTranslation(['vantablack/server/dashboard', 'vantablack/utilities']);
                ...
                <p>
                    ...
                    >
                        {status === 'offline' 
                            ...
                            : status === 'running'
                            ? t('online', { ns: 'vantablack/utilities' })
                            : status === 'starting'
                            ? t('starting', { ns: 'vantablack/utilities' })
                            : status === 'stopping'
                            ? t('stopping', { ns: 'vantablack/utilities' })
                            : ''
                        }
                    </span>
                </p>
