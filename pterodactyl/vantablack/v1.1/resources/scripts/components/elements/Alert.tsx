...
import { LuPartyPopper, LuMegaphone, LuInfo, LuAlertCircle, LuAlertTriangle, LuCheckCircle2, LuXCircle } from "react-icons/lu";
...
const Alert = () => {
    ...
    const announcementType = useStoreState((state: ApplicationStore) => state.settings.data!.vantablack.announcementType);
    const announcementCloseable = useStoreState((state: ApplicationStore) => state.settings.data!.vantablack.announcementCloseable);
    const announcementMessage = useStoreState((state: ApplicationStore) => state.settings.data!.vantablack.announcementMessage);
