...
export default () => {
    ...
    const lowResourcesAlert = String(useStoreState((state: ApplicationStore) => state.settings.data!.vantablack.lowResourcesAlert));
    const billing = String(useStoreState((state: ApplicationStore) => state.settings.data!.vantablack.billing));
