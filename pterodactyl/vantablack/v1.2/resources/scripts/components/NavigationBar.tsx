...
const ClientDropdown = ({ sideBar }: Dropdown) => {
    ...
    const { t } = useTranslation(['vantablack/navigation']);

    const modeToggler = useStoreState((state: ApplicationStore) => state.settings.data!.vantablack.modeToggler);
...
export default ({ children }: Props) => {
    ...
    const layout = useStoreState((state: ApplicationStore) => state.settings.data!.vantablack.layout);
    ...
    const searchComponent = useStoreState((state: ApplicationStore) => state.settings.data!.vantablack.searchComponent);
